...
import com.ut.loans.express.processing.dto.response.ResponseField;
...
public class RestExceptionHandler{
      ...
      if(ex instanceof IllegalStateException){
        ...
        if(ex instanceof RecordNotFoundException){
         ...
         if(ex instanceof FileNotFoundException){
            return new ResponseEntity<>(responseField.setFileNotFound(ex.getMessage()),HttpStatus.NOT_FOUND);
           }
   ...
   public ResponseEntity<Object> fileNotFoundException(FileNotFoundException exception) {
      return new ResponseEntity<>(responseField.setFileNotFound(exception.getMessage()), HttpStatus.NOT_FOUND);
   }
